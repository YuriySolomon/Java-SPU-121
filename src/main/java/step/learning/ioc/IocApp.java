...
- за замовченням залежності впроваджуються як Transient, тобто новий об'єкт у
    кожній точці інжекції. Альтернативний варіант - Singleton, коли всі точки інжекції
    отримують один об'єкт зазначається анотацією до класу-залежності (сервісу)
- інжекція через конструктор дозволяє утворювати константні посилання на служби,
    ...
    переж конструктором. усі його параметри є інжектованими
- DIP рекомендує створювати інтерфейси і зазаначати залежності від них, це спрощує
    зміну служб без втручання і код точок інжекції. Але при цьому вимагається
...
- За потреби кількох реалізацій одного типу (інтерфейсу) вживаються іменовані
    залежності. Точки інжекції анотуються @Named("Hash-128"). а інструкції зв'язування
