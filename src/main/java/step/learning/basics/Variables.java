...
public class Variables {
    ...
    public void demo() {
        ...
        /* З примітивними типами можуть виникати обмеження при спробі
           їх використання у generic виразах (<T>). Для таких цілей є
           референсні аналоги цих типів:
         */
        Byte    xxb = 10;
        Short   xxs = 100;
        Integer xxi = 10000;
        ...
        /* String - аналогічно з C# - не змінний (immutable)б всі операції
           ...
           вже наявне посилання, новій літерал не створюється)
         */
        ...
        /* Перевантаження операторів у Java немає.
           Оператор порівняння (==) діє за рефернсним принципомб тобто true для  двох
        ...
        //  Object - батьківський об'єкт для всії типів
        Object obj = new Object();
        System.out.println( obj );  // -> obj.toString()
    }
}
/*
JavaDoc - система коментарів-документацій (/** ...)
 */