...
public class RandomDao {
    ...
    public void insertRandom() {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(sql)){
            ...
            preparedStatement.setInt(   2, randomService.getInt());
            preparedStatement.setDouble(3, randomService.getDouble());
            preparedStatement.setString(4, randomService.getString());

            // після встановлення всіх параметрів запит виконуємо типовим способом
    ...
    public void insert(RandomRecord record) {
        ...
        RandomDao. забезпечити його перевірку у DbApp (замість
        insertRandom використати insert)
        Додати та випробувати методи RandomDao:
        delete (RandomRecord record)
        update (RandomRecord record) - оновлюються дані по record.id
